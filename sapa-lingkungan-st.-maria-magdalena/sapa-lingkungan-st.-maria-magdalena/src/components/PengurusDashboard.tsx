      ...
      <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-amber-700 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="px-3.5 py-2 bg-red-800/80 hover:bg-red-900 text-white font-bold text-xs rounded-xl border border-red-400/50 flex items-center gap-1.5 transition-all shadow-xs cursor-pointer active:scale-95 whitespace-nowrap self-start sm:self-auto"
            title="Hapus seluruh data demo dari Firestore & Perangkat agar database bersih"
          >
            <Trash2 className="w-4 h-4 text-red-200" />
            <span>Kosongkan Data Demo</span>
          </button>
        </div>
      </div>
