...
export interface WilayahGroup {
  category: string;
  items: string[];
}

export const WILAYAH_GROUPS: WilayahGroup[] = [
  {
    category: 'Wilayah Timur',
    items: [
      'Wilayah Timur - St. Maria Magdalena - Semampir',
      'Wilayah Timur - St. Monica - Brawijaya',
      'Wilayah Timur - St. Kristoforus - Jongbiru',
      'Wilayah Timur - St. Giovanni - Diponegoro',
    ],
  },
  {
    category: 'Wilayah Stasi',
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      'Wilayah Utara - St. Maria - Mojoroto Selatan',
      'Wilayah Utara - St. Ignatius - Dermo',
      'Wilayah Utara - St. Benediktus - Ngampel',
      'Wilayah Utara - St. Augustinus - Mojoroto Tengah',
    ],
  },
  {
    ...
    items: [
      ...
      'Wilayah Selatan - St. Yosef - Sukorame Utara',
      'Wilayah Selatan - St. Yoh. Pemandi - Bujel',
      'Wilayah Selatan - St. Helena - Wilis Indah',
      'Wilayah Selatan - St. F.Xaverius - Bandar Timur',
      'Wilayah Selatan - St. Andreas - Sukorame Selatan',
    ],
  },
];

export const LIST_16_WILAYAH = WILAYAH_GROUPS.flatMap((g) => g.items);
