  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden border border-orange-100 animate-in fade-in zoom-in duration-200">
        ...
        {/* Modal Header */}
        <div className="bg-gradient-to-r from-red-700 via-orange-600 to-red-600 px-6 py-4 text-white flex items-center justify-between shadow-md">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="pt-2 flex items-center justify-end gap-2">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl text-xs font-extrabold bg-gradient-to-r from-red-600 via-orange-600 to-amber-600 hover:from-red-700 hover:to-orange-700 text-white shadow-md hover:shadow-lg transition-all flex items-center gap-1.5 active:scale-95 disabled:opacity-50 cursor-pointer"
            >
