...
export const PengurusDashboard: React.FC<PengurusDashboardProps> = ({ user, addToast }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
      ...
      {/* Pengurus Banner */}
      <div className="bg-gradient-to-r from-red-700 via-orange-600 to-red-600 rounded-2xl p-4 sm:p-6 text-white shadow-lg relative overflow-hidden border border-red-800/40">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-1">
              <div className="inline-flex items-center gap-1.5 bg-white/20 px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs font-bold text-amber-100 border border-white/30 backdrop-blur-xs">
                <ShieldCheck className="w-3.5 h-3.5" /> Mode Pengurus Lingkungan (Akses Penuh CRUD)
              </div>
          ...
          <div className="flex flex-wrap items-center gap-2 self-start md:self-auto shrink-0">
            <button
              ...
              className="px-3 py-2 bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-white font-bold text-xs rounded-xl border border-orange-400/40 flex items-center gap-1.5 transition-all shadow-md cursor-pointer active:scale-95 whitespace-nowrap disabled:opacity-50"
              title="Unggah data yang diisi di browser/HP ini ke Cloud Firestore agar dapat dibuka di Vercel/HP/Laptop lain"
            >
              {isSyncingCloud ? <RefreshCw className="w-3.5 h-3.5 animate-spin" /> : <CloudUpload className="w-3.5 h-3.5 text-amber-200" />}
            ...
            <button
              ...
              disabled={isSyncingCloud}
              className="px-3 py-2 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white font-bold text-xs rounded-xl border border-amber-400/40 flex items-center gap-1.5 transition-all shadow-md cursor-pointer active:scale-95 whitespace-nowrap disabled:opacity-50"
              title="Tarik & perbarui data terbaru yang tersimpan di Cloud Firestore"
            >
              {isSyncingCloud ? <RefreshCw className="w-3.5 h-3.5 animate-spin" /> : <CloudDownload className="w-3.5 h-3.5 text-orange-200" />}
            ...
            <button
              ...
              className="px-3 py-2 bg-red-800 hover:bg-red-900 text-white font-bold text-xs rounded-xl border border-red-500/50 flex items-center gap-1.5 transition-all shadow-md cursor-pointer active:scale-95 whitespace-nowrap"
      ...
      {/* Navigation Tabs Bar */}
      <div className="bg-white p-2 rounded-2xl shadow-xs border border-orange-200/80 flex items-center gap-1 overflow-x-auto no-scrollbar">
        <button
          type="button"
          onClick={() => setActiveTab('warga')}
          className={`px-4 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2 whitespace-nowrap cursor-pointer active:scale-95 ${
            activeTab === 'warga'
              ? 'bg-gradient-to-r from-red-600 via-orange-600 to-amber-600 text-white shadow-md shadow-red-600/20 font-extrabold border border-orange-400/30'
          ...
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-orange-100 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 text-xs">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-red-600 via-orange-600 to-amber-600 hover:from-red-700 hover:to-orange-700 text-white font-extrabold text-xs rounded-xl shadow-md transition-all flex items-center gap-1.5 shrink-0 cursor-pointer active:scale-95 border border-orange-400/30"
              >
                              ...
                              >
                                <div className="space-y-0.5">
                                  ...
                                  <div className="text-[11px] text-slate-500 flex items-center gap-3">
                                    ...
                                    <span className="inline-flex items-center gap-1">• Usia: <WetonAgeDisplay birthDateString={ak.tanggal_lahir} nama={ak.nama_lengkap} /></span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-2 sm:p-4 overflow-hidden">
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3.5 text-slate-800">
              ...
              <DateInputFormatted
                label="Tanggal Transaksi Setoran"
                required
                value={iuranForm.tanggal_bayar || ''}
                onChange={(val) => handleIuranDateChange(val)}
              />
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <DateInputFormatted
                    ...
                    onChange={(val) => setKegiatanForm({ ...kegiatanForm, tanggal: val })}
                  />
                </div>
                <div>
