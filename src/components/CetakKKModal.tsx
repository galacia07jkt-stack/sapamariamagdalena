...
import { calculateAge, formatAgeWithDays } from '../lib/helpers';
                  ...
                  <tbody className="divide-y divide-slate-200 print:divide-black">
                    {members.map((ak, idx) => (
                      <tr key={ak.id || idx} className="hover:bg-slate-50">
                        ...
                        <td className="border border-slate-300 print:border-black p-2 text-center text-xs whitespace-nowrap font-medium"><WetonAgeDisplay birthDateString={ak.tanggal_lahir} nama={ak.nama_lengkap} /></td>
